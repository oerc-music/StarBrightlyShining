...
console.log('---------------------------------this is the obj.genre line')
//    obj.genre = vivoScore[pref.dbpedia+"genre"][pref.schema+"about"][pref.schema+"name"];
console.log(obj.genre)
console.log(vivoScore[pref.dbpedia+"genre"])

//		obj.publisher = vivoScore[pref.dce+"publisher"]; // Change so we have name, not URL

try {
  console.log('arranger: '+vivoScore[pref.dbpedia+"arranger"][pref.schema+"about"][pref.schema+"name"])
  console.log('publisher: '+vivoScore[pref.dbpedia+"publisher"][pref.schema+"about"][pref.schema+"name"])
} catch (er){
  console.log('error message no arr or publ'+er)
  console.log(vivoScore[pref.dbpedia+"arranger"])
}
