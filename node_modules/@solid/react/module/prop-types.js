import { array, element, func, number, object, string, oneOfType } from 'prop-types';
...
setPropTypes(Image, srcAndChildren, {
  defaultSrc: string
});
...
setPropTypes(LiveUpdate, {
  subscribe: oneOfType([array, string])
});