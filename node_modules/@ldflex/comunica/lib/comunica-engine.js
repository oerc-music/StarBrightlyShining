const df_281_0 = new (require('@comunica/logger-void').LoggerVoid)(undefined);
...
const df_613_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_613_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const df_613_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const urn_comunica_sparqlinit = new (require('@comunica/actor-init-sparql').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': df_613_0,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': df_613_1,
